...
import com.google.gwt.sample.stockwatcher.ejb.ActionEJB;
...
//            InitialContext ctx = ContextGenerator.getContext();
//
//            ActionEJBRemote remote = (ActionEJBRemote) ctx.lookup("java:global/gwt_ejb_ejb_exploded/ActionEJB!stockwatcher.ejb.remote.ActionEJBRemote");
//
//            double result = remote.getStockPrice(symbol);
//            if(result > 0)
//                return new ActionGWT(symbol, remote.getStockPrice(symbol));
